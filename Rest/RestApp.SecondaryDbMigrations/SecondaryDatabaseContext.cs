...
namespace RestApp.SecondaryDbMigrations;

public partial class SecondaryDatabaseContext : DbContext
{
    public SecondaryDatabaseContext(DbContextOptions<SecondaryDatabaseContext> options)
        : base(options)
    {
    }
